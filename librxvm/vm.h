...
struct threads {
    int64_t chars;          /* Number of input chars processed */
    int64_t match_start;    /* Start of matching portion of input stream */
    int64_t match_end;      /* End of matching portion of input stream */
